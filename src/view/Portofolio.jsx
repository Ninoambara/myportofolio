                ...
                {items.map((item) => (
                  <div key={item.id}>
                    <div className="item-card flex flex-col items-center gap-2 rounded bg-[#1e1e1f] hover:bg-[#282828] border border-[#383838] rounded-xl text-amber-50 md:gap-3 px-5 py-5 lg:px-5">
                      ...
                      <div className="w-full flex flex-col gap-2 items-center text-sm md:text-base lg:text-sm">
                        <div className="title-text font-medium text-secondary">
                          {item.name}
                        </div>
                        <div className="w-full text-left text-[10px] text-[#c1c1c1] md:text-xs lg:text-[15px]">
                          {item.status}
                        </div>
